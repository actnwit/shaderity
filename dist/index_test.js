...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"in float a_testA;\\nin lowp float a_testB;\\n\\nout float v_testA;\\nout lowp float v_testB;\\n\\nvoid main() {}\\n\",\"shaderStage\":\"vertex\",\"isFragmentShader\":false});\n\n//# sourceURL=webpack://shaderity/./assets/attribute_and_varying_precision_es3.vert?\n}");

/***/ }),

/***/ "./assets/complex_macro.frag":
/*!***********************************!*\
  !*** ./assets/complex_macro.frag ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"#define VERSION 2\\n#if VERSION > 1\\n    // バージョン1より新しい\\n#endif\\n#define DEBUG\\n#define RELEASE\\n#if defined(DEBUG) && !defined(RELEASE)\\n    // デバッグビルド\\n#else\\n    // リリースビルド\\n#endif\\n#define LINUX\\n#if defined(WINDOWS) || defined(LINUX)\\n    // Windows または Linux\\n#endif\\n#ifndef MACOS\\n    // MACOSではない\\n#endif\\n#define FEATURE_A\\n#define BETA\\n#if defined(FEATURE_A) && (VERSION > 2 || defined(BETA))\\n    // 複雑な条件による分岐\\n#endif\\n#if(VERSION==2)\\n    // 空白なしのif文\\n#endif\\n#ifVERSION==2 // プラグマとして認識しない\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/complex_macro.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"precision mediump float;\\n\\nin vec4 vColor;\\n\\n/* shaderity: @{var_a} */\\n/* shaderity: @{ var_b } */\\n\\nvoid main() {\\n  gl_FlagColor = zero_one(vColor);\\n}\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/dynamic_template_es1.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"precision mediump float;\\n\\n#define GL_ES\\n#define GL_ES2\\n#define GL_ES4\\n\\n#ifdef GL_ES\\nin vec4 vColor;\\n#elif defined(GL_ES2)\\nin vec4 vColor2;\\n#endif\\n\\n#ifdef GL_ES3\\nin vec4 vColor3;\\n#elif defined(GL_ES4)\\nin vec4 vColor4;\\n#endif\\n\\n#ifdef GL_ES5\\nin vec4 vColor5;\\n#elif defined(GL_ES6)\\nin vec4 vColor6;\\n#else\\nin vec4 vColor7;\\n#endif\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/elif.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"precision mediump float;\\n\\n#define GL_ES\\n\\n#ifdef GL_ES\\nin vec4 vColor;\\n#endif\\n\\n#ifdef GL_ES2\\nin vec4 vTexcoord;\\n#endif\\n\\n#ifdef GL_ES\\nin vec4 vColor2;\\n#else\\nin vec4 vTexcoord2;\\n#endif\\n\\n#ifdef GL_ES2\\nin vec4 vTexcoord;\\n#else\\nin vec4 vNormal;\\n#endif\\n\\nvoid main() {\\n  gl_FlagColor = vColor;\\n}\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/ifdef.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"precision mediump float;\\n\\n#define GL_ES\\n#define GL_ES_3\\n\\n#ifdef GL_ES\\nin vec4 vColor;\\n  #ifdef GL_ES_3\\n    in vec4 vTexcoord2;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\n#else\\nin vec4 vTexcoord4;\\n#endif\\n\\n#ifdef GL_ES\\n  #ifdef GL_ES_2\\n    in vec4 vTexcoord2;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\nin vec4 vColor;\\n#else\\nin vec4 vTexcoord4;\\n#endif\\n\\n#ifdef GL_ES_4\\nin vec4 vColor;\\n  #ifdef GL_ES\\n    in vec4 vTexcoord5;\\n  #else\\n    in vec4 vTexcoord6;\\n  #endif\\n#else\\nin vec4 vTexcoord7;\\n#endif\\n\\n#ifdef GL_ES_4\\nin vec4 vColor;\\n  #ifdef GL_ES_5\\n    in vec4 vTexcoord8;\\n  #else\\n    in vec4 vTexcoord9;\\n  #endif\\n#else\\nin vec4 vTexcoord10;\\n#endif\\n\\n#ifdef GL_ES2\\nin vec4 vColor;\\n#else\\nin vec4 vTexcoord4;\\n  #ifdef GL_ES_3\\n    in vec4 vTexcoord2;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\n#endif\\n\\n#ifdef GL_ES2\\nin vec4 vColor;\\n#else\\n  #ifdef GL_ES_2\\n    in vec4 vTexcoord2;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\nin vec4 vTexcoord4;\\n#endif\\n\\n#ifdef GL_ES2\\nin vec4 vTexcoord1;\\n  #ifdef GL_ES_2\\n    in vec4 vTexcoord2;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\nin vec4 vTexcoord4;\\n#endif\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/ifdef2.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"precision mediump float;\\n\\n#define GL_ES\\n#define GL_ES_2\\n#define GL_ES_3\\n\\n#ifdef GL_ES\\nin vec4 vColor;\\n  #ifdef GL_ES_2\\n    #ifdef GL_ES_3\\n      in vec4 vTexcoord0;\\n    #else\\n      in vec4 vTexcoord1;\\n    #endif\\n    in vec4 vTexcoord2;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\n#else\\nin vec4 vTexcoord4;\\n#endif\\n\\n#ifdef GL_ES_1\\nin vec4 vColor;\\n#elif defined(GL_ES)\\n  #ifdef GL_ES_2\\n    #ifdef GL_ES_3\\n      in vec4 vTexcoord0;\\n    #else\\n      in vec4 vTexcoord1;\\n    #endif\\n    in vec4 vTexcoord2;\\n  #elif defined(GL_ES_3)\\n    in vec4 vTexcoord0;\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\n#else\\nin vec4 vTexcoord4;\\n#endif\\n\\n#ifdef GL_ES_1\\nin vec4 vColor;\\n#elif defined(GL_ES_0)\\nin vec4 vColor2;\\n#else\\n  #ifdef GL_ES_4\\n    in vec4 vTexcoord2;\\n  #elif defined(GL_ES_3)\\n    in vec4 vTexcoord0;\\n    #ifdef GL_ES_5\\n      in vec4 vTexcoord0;\\n    #else\\n      in vec4 vTexcoord1;\\n    #endif\\n  #else\\n    in vec4 vTexcoord3;\\n  #endif\\nin vec4 vTexcoord4;\\n#endif\\n\\n#ifdef GL_ES_5\\n  #ifdef GL_ES_6\\n    in vec4 vTexcoord1;\\n  #else\\n    #ifdef GL_ES_7\\n    in vec4 vTexcoord2;\\n    #else\\n    in vec4 vTexcoord3;\\n    #endif\\n  #endif\\n#endif\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/ifdef3.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"in vec3 position;\\n\\nvoid main () {\\n  gl_Position = vec4(position, 1.0);\\n}\\n\",\"shaderStage\":\"vertex\",\"isFragmentShader\":false});\n\n//# sourceURL=webpack://shaderity/./assets/insert_definition_es3.vert?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"layout(location = 0) out vec4 rt0;\\n\\nvoid main () {\\n  if(false){\\n    return;\\n  }\\n}\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/out_qualifier_fragment_es3.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"#version 300 es\\n\\nlayout(location = 0) out vec4 renderTarget0;\\n\\nvoid main() {}\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/out_to_gl_frag_color.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"in vec3 a_position;\\nin vec2 a_uv; // < semantic=TEXCOORD_0 >\\nout vec3 v_position;\\n\\nuniform vec4 u_worldMatrix;\\nuniform sampler2D u_texture; // <semantic=DataTexture, min=10, max=100, default=>\\n\\nint main() {\\n  gl_Position = a_position;\\n  v_position = a_position;\\n}\\n\",\"shaderStage\":\"vertex\",\"isFragmentShader\":false});\n\n//# sourceURL=webpack://shaderity/./assets/reflection_es3.vert?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"precision mediump float;\\n\\nin vec4 vColor;\\nin vec4 vTexcoord;\\n\\nvoid main() {\\n  gl_FlagColor = vColor;\\n}\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack://shaderity/./assets/simple_es3.frag?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"in vec3 position;\\nin vec4 color;\\nuniform mat4 matrix;\\nout vec4 vColor;\\n\\nvoid main () {\\n  vColor = color;\\n  gl_Position = matrix * position;\\n}\\n\",\"shaderStage\":\"vertex\",\"isFragmentShader\":false});\n\n//# sourceURL=webpack://shaderity/./assets/simple_es3.vert?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\"code\":\"#version 300 es\\n\\nprecision highp int;\\nprecision highp float;\\nprecision highp sampler2D;\\nprecision highp samplerCube;\\n\\nout float v_testA;\\nsmooth out lowp mat2 v_testB;\\n\\nvoid main() {}\\n\",\"shaderStage\":\"vertex\",\"isFragmentShader\":false});\n\n//# sourceURL=webpack://shaderity/./assets/smooth_varying_es3.vert?\n}");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src_for_test/index_test.js");
/******/ 	
/******/ })()
;