...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\"code\":\"#define VERSION 2\\n#if VERSION > 1\\n    // バージョン1より新しい\\n#endif\\n#define DEBUG\\n#define RELEASE\\n#if defined(DEBUG) && !defined(RELEASE)\\n    // デバッグビルド\\n#else\\n    // リリースビルド\\n#endif\\n#define LINUX\\n#if defined(WINDOWS) || defined(LINUX)\\n    // Windows または Linux\\n#endif\\n#ifndef MACOS\\n    // MACOSではない\\n#endif\\n#define FEATURE_A\\n#define BETA\\n#if defined(FEATURE_A) && (VERSION > 2 || defined(BETA))\\n    // 複雑な条件による分岐\\n#endif\\n\",\"shaderStage\":\"fragment\",\"isFragmentShader\":true});\n\n//# sourceURL=webpack:///./assets/complex_macro.frag?");
