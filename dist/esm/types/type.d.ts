...
export type VarType = 'unknown' | 'float' | 'int' | 'vec2' | 'vec3' | 'vec4' | 'mat2' | 'mat3' | 'mat4' | 'ivec2' | 'ivec3' | 'ivec4' | 'sampler2D' | 'sampler3D' | 'samplerCube';
...
export type ShaderPrecisionObjectKey = 'int' | 'float' | 'sampler2D' | 'samplerCube' | 'sampler3D' | 'sampler2DArray' | 'isampler2D' | 'isamplerCube' | 'isampler3D' | 'isampler2DArray' | 'usampler2D' | 'usamplerCube' | 'usampler3D' | 'usampler2DArray' | 'sampler2DShadow' | 'samplerCubeShadow' | 'sampler2DArrayShadow';
...
export type ShaderConstantValueVarTypeES1 = 'float' | 'vec2' | 'vec3' | 'vec4' | 'int' | 'ivec2' | 'ivec3' | 'ivec4' | 'bool' | 'bvec2' | 'bvec3' | 'bvec4' | 'mat2' | 'mat3' | 'mat4';
export type ShaderConstantValueVarTypeES3 = 'float' | 'vec2' | 'vec3' | 'vec4' | 'int' | 'ivec2' | 'ivec3' | 'ivec4' | 'bool' | 'bvec2' | 'bvec3' | 'bvec4' | 'uint' | 'uvec2' | 'uvec3' | 'uvec4' | 'mat2' | 'mat3' | 'mat4' | 'mat2x2' | 'mat2x3' | 'mat2x4' | 'mat3x2' | 'mat3x3' | 'mat3x4' | 'mat4x2' | 'mat4x3' | 'mat4x4';
...
export type ShaderAttributeVarType = 'float' | 'vec2' | 'vec3' | 'vec4' | 'int' | 'ivec2' | 'ivec3' | 'ivec4' | 'mat2' | 'mat3' | 'mat4';
...
export type ShaderVaryingInterpolationType = 'flat' | 'smooth';
